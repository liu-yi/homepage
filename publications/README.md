...
2. **Efficient and Privacy-Preserving Ride Matching over Road Networks against Malicious ORH server** <span class="pubtag">[:link:](https://doi.org/10.1109/TIFS.2025.3544453)</span>
...
1. **Enabling Privacy-Preserving and Publicly Auditable Federated Learning** <span class="pubtag">[:link:](https://ieeexplore.ieee.org/document/10622406)</span>
