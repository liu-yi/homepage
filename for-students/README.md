?> 以下内容介绍了我的研究方向及研究生招生要求。如果你有意报考我的研究生，或者作为本科生有进行相关科研的兴趣，欢迎通过邮件与我联系（邮箱 `i (AT) liuyi.pro` 或 `liuyi (AT) jnu.edu.cn`）。无论是否匹配我当前能够接收的方向，我都会尽量在 3 天内回复邮件；如果超过 3 天（72小时）仍未收到回复，可能是你的邮件被误判为垃圾邮件，或者我的回信被你的邮箱归入了垃圾邮件，可以考虑重新发送一次。
...
- 为了在主动安全和高效率之间取得更好的平衡，我们提出了主动安全下的1比特优势界（One-Bit Advantage Bound）安全模型。该模型允许恶意参与方相对诚实方至多多获得1比特的额外信息，从而在显著提升安全性的同时避免传统主动安全协议带来的高昂开销。基于这一新模型，我们设计了一种高效的通用两方计算协议：它采用“先验证、后释放”的逐位输出方式，既能保证诚实方输出结果的正确性，也将恶意方的额外信息优势严格限制在1比特以内；同时，其通信和计算开销都已非常接近被动安全协议。
...
# 研究生招生意向
我每年可以指导2名硕士生。希望你具备扎实的计算机科学基础、较强的自学能力及求知热情，并能自我激励。当前，我正活跃于学术一线；若你对我的研究方向感兴趣，我们可携手开展相关工作。建议你在与我联系之前，先选择阅读我以第一作者发表在 S&P 2025、ASIACRYPT 2023、ESORICS 2022、PKC 2022 上的一篇或多篇论文，以便对我当前的研究方向形成初步认识。你无需预先具备密码学或安全领域的经验，但如果已有相关背景，会更有助于后续开展研究工作。如果你对我现有的研究方向兴趣没有那么强，但对其他与我研究兴趣相关的方向有较明确的兴趣，并希望由我担任导师，也欢迎与我联系；在这种情况下，我也会尽我所能提供支持和指导。
