...
public:
    ...
    {
        a += 3; // it can be changed after initialization
    ...
    void foo(int a){
        cout << "This is foo(int) in Derived. " << endl;
    }
    void foo(){ // if we delete this function?
        cout << "This is foo() in Derived. " << endl;
    }
